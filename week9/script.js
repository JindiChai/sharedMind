...
async function createUniverse(universalMotto) {
    let text = "give me a json object with 36 Hex color codes related to " + universalMotto + "in text";
    ...
    console.log("embeddingsJSON", embeddingsJSON);
    console.log("embeddingsJSON.output", embeddingsJSON.output);
